...
public class CurseEvents {
	...
	public static void onLivingDrops(LivingDropsEvent event) {
		if (event.getEntity() != null && event.getSource() != null) {
			if (event.getSource().getEntity() != null) {
				...
				if (source instanceof Player player && CurseHelpers.isCursed(player) && (CurseModConfig.DROPS.get() == true)) {
	...
	public static void onLooter(LootingLevelEvent event) {
		if (event.getDamageSource() != null) {
			if (event.getDamageSource().getEntity() != null) {
				...
				int loot = event.getLootingLevel();
				if (source instanceof Player player && CurseHelpers.isCursed(player) && (CurseModConfig.LOOT.get() == true)) {
	...
	public static void onBlockBreak(BlockEvent.BreakEvent event) {
		...
		if (CurseHelpers.isCursed(player) && !player.isCreative() && (CurseModConfig.ORE.get() == true)) {
